...
const NOT_IN_THE_SHEET: Record<string, string> = {
  ...
  // TEMPORARY. The column is dead and migration 372 drops it; the generated
  ...
  // the reminder to delete it (it worked for uses_day_builder, #488).
  pricing_mode: 'dead flag, dropped by migration 372 — remove this line when the types are regenerated',
}
