...
// ONCE and the callers feed it:
//   • the rate-sheet derivation — lib/auto-pricing-service.ts (calculateDayBasedPricing)
//
// Sits next to rate-resolution.ts as part of the canonical pricing core.
