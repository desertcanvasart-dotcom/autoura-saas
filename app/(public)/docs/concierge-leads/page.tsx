    ...
    <div>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mb-3">
          Open <strong>Concierge Leads</strong> in the sidebar (Communicate group, second from the top). Briefs arrive automatically &mdash; there is nothing to import. The page is organized into tabs with live counts:
        </p>
