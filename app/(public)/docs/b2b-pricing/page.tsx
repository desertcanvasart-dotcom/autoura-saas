  ...
  return (
    <div>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 mt-3">
          Per-unit and tiered activity behavior is driven by <strong>Activities &amp; Add-ons</strong> (Suppliers &amp; Rates &rarr; Guides &amp; Services &rarr; Activities); transport vehicle-tier stepping is driven by the <strong>Transport Packages</strong> page (Tours &rarr; Transport Packages). See <Link href="/docs/b2b-pricing-rules" className="text-primary-600 hover:underline">Transport Packages</Link> for details.
        </p>
        <p className="text-gray-600 mt-3">
