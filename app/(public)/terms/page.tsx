        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-600">
                New accounts may be eligible for a {TRIAL_DAYS}-day free trial. At the end of the trial period, your account will be automatically converted to a paid subscription unless cancelled.
              </p>
            </section>
