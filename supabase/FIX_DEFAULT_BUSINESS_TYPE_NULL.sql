-- Fix: Don't set a default business_type during signup
-- Users should choose it during onboarding

-- Update the signup trigger to NOT set business_type
...
-- Update existing tenants that haven't completed onboarding to NULL business_type
UPDATE tenants
...
WHERE tf.onboarding_completed = false
LIMIT 5;
